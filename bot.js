...
client.on('message', msg => {
    ...
    spotifyApi.clientCredentialsGrant()
      .then(function (data) {
        ...
        if (msg.content.match('!spotify help*')) {
          msg.channel.sendMessage('Taper !spotify track suivi de la recherche pour afficher le top 3')
          msg.channel.sendMessage('Taper !spotify artiste suivi de la recherche pour afficher le top 3')
          msg.channel.sendMessage('Taper !spotify album suivi de la recherche pour afficher le top 3')
          //Pour tous 
          msg.channel.sendMessage('Taper !spotify suivi de la recherche pour afficher le top 3')
        
  // Instruction Chanson
        } else if (msg.content.match('!spotify track *') & !msg.content.match('Taper !spotify track suivi de la recherche pour afficher le top 3*')) {
  ...
  //Instruction Artiste
        } else if (msg.content.match('!spotify artiste *') & !msg.content.match('Taper !spotify artiste suivi de la recherche pour afficher le top 3*')) {
  ...
  //Instructions Album
        } else if (msg.content.match('!spotify album *') & !msg.content.match('Taper !spotify album suivi de la recherche pour afficher le top 3*')) {
 ...
 //Instruction pour la recherche avec chanson, artiste et album 
        } else if (msg.content.match('!spotify *') & !msg.content.match('Taper !spotify suivi de la recherche pour afficher le top 3*')) {
